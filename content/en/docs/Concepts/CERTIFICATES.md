...
It's possible to regenerate Kubernetes control plane certificates with LambdaStack.
...
This part cannot be done by LambdaStack. Refer to official Kubernetes [documentation](https://kubernetes.io/docs/tasks/tls/manual-rotation-of-ca-certificates/) to perform this task.
