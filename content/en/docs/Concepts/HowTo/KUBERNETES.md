...
The default applications configuration available [here](https://github.com/lambdastack/lambdastack/blob/master/data/common/defaults/configuration/applications.yml)
