...
LambdaStack provides Alertmanager configuration via configuration manifest. To see default configuration please refer to [default Prometheus configuration file](https://github.com/lambdastack/lambdastack/blob/master/data/common/defaults/configuration/prometheus.yml).  
...
To enable particular Grafana dashboard, refer to [default Grafana configuration file](https://github.com/lambdastack/lambdastack/blob/master/data/common/defaults/configuration/grafana.yml), copy `kind: configuration/grafana` section to your configuration manifest and uncomment desired dashboards.
